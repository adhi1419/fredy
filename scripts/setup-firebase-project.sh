...
echo ""
echo "======================================================================"
echo "DONE. Three things remain:"
echo ""
echo "1. Enable Google sign-in (2 clicks):"
echo "   https://console.firebase.google.com/project/$PROJECT/authentication/providers"
echo ""
echo "2. Add the GitHub Pages host to Firebase Authentication authorized domains:"
echo "   Firebase console -> Authentication -> Settings -> Authorized domains"
echo "   Add: adhi1419.github.io"
echo ""
echo "3. Deploy the API-only Cloud Run service (see doc/cloud-run-deployment.md):"
