...
import type { TravelTimeEntry } from '../../transit/travelTimeFormat.js';
...
/**
 * One listing row as it arrives from the listings store. Deliberately loose - the store hands these
 * through untyped, and the grid only reads a known subset of the columns.
 */
export interface ListingItem {
  ...
  affordabilityVerdict?: Verdict | null;
...
interface ListingsGridProps {
  ...
  onWatch: (event: MouseEvent, item: ListingItem) => void;
  onNavigate: (id: string) => void;
  onDelete: (id: string) => void;
  onRestore?: (id: string) => void;
  onReactivate?: (id: string) => void;
  isHiddenView?: boolean;
  onStatusChange: (item: ListingItem, next: string | null) => void;
}
        ...
        >
          ...
          >
            <StatusControl
              ...
              onTriggerClick={(e: SyntheticEvent) => e.stopPropagation()}
            />
