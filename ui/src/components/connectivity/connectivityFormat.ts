 ...
 * framework along.
 */
export const CONNECTIVITY_SOURCES: string[] = ['de-bba', 'ch-bakom'];
 ...
 */
export const DOWNSTREAM_FILTER_STEPS: number[] = [30, 100, 1000];
 ...
 */
export const FILTERABLE_TECHNOLOGIES: string[] = ['4g', '5g', '5g_sa'];
 ...
 */
export const FILTERABLE_OPERATORS: string[] = ['dt', 'vf', 'tf', 'ee'];
 ...
 */
export const DISPLAY_MOBILE_TECHNOLOGIES: string[] = ['5g_sa', '5g', '4g', '2g'];
 ...
 */
export const DISPLAY_TECHNOLOGIES: string[] = ['ftthb', 'hfc', 'fttc'];
 ...
 */
export const SOURCE_ATTRIBUTION: Record<string, SourceAttribution> = {
  'de-bba': {
 ...
 */
export function formatDownstream(mbit: number | null): string | null {
 ...
 */
export function roundShare(share: number | null): number | null {
