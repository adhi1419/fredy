 ...
 */
export default function TrendSparkline({ data = [], locale = 'de-DE', height = 44 }: TrendSparklineProps) {
    ...
    () => ({
      ...
      plugins: {
        ...
        tooltip: {
          displayColors: false,
          callbacks: {
            title: (items: TooltipItem<'line'>[]) => new Date(items[0].label).toLocaleDateString(locale),
