 ...
 */
function euroFormatter(locale: string, fractionDigits: number): Intl.NumberFormat {
 ...
 * @returns {string}
 */
export const formatEuroPrice = (price: number | string, locale: string = DEFAULT_LOCALE): string => {
