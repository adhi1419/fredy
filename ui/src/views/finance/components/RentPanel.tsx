...
import type { BudgetView, FinanceProfile, RentParams, RentThresholds } from '../../../types/finance.js';
...
interface RentPanelProps {
  ...
  /** The household budget for the current draft. */
  budget: BudgetView | null;
  /** Rent ceilings for the draft. */
  thresholds: RentThresholds | null;
  /** Shallow-merged into profile.renting. */
  onChange: (patch: Partial<RentParams>) => void;
}
 ...
 */
export default function RentPanel({ profile, budget, thresholds, onChange }: RentPanelProps) {
