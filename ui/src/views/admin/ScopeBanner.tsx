...
/** The store slices this banner reads. */
interface ScopeBannerState {
  generalSettings: { settings: { baseUrl?: string } };
}
 ...
 */
export default function ScopeBanner(): ReactElement {
  const t = useTranslation();
  const baseUrl = useSelector<ScopeBannerState, string | undefined>((state) => state.generalSettings.settings.baseUrl);
