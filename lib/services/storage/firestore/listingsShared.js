 ...
 *   notes (string|null), status (string|null), inquiryMessage, inquirySendStatus,
 *   inquirySendStartedAt, inquirySentAt, inquiryRequestId, inquirySendError,
...
/**
 * Every non-deleted listing's similarity-relevant fields (cache rebuild).
 * Mirrors the sqlite projection: job_id, provider, title, address, price,
 * size, rooms, description.
 */
