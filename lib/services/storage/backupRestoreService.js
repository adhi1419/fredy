 ...
 *
 * Re-exports the backupRestoreService implementation for the
...
const impl = isFirestore()
  ? await import('./firestore/backupRestoreService.js')
  : await import('./sqlite/backupRestoreService.js');

export const { createBackupZip, precheckRestore, restoreFromZip, buildBackupFileName } = impl;
