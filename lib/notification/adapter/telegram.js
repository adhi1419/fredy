 ...
 * mobile — the whole point is the user forwards it to the landlord. Sent through the SAME
 * throttled caller so it obeys Telegram's per-chat rate limit. A missing draft (feature off, no
