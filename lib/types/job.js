 ...
 * @property {Array<{id?: string, name?: string, url?: string, enabled?: boolean, applicationPolicy?: {automatic: 'enabled'|'disabled'}}>} [provider] Provider configuration list. `applicationPolicy` is additive. Persisted source state wins on reads; writes that supply legacy `autoSendInquiry` use that value during the compatibility window, while policy-only writes use source state.
 ...
 * @property {boolean} [autoSendInquiry] Whether supported providers may submit generated inquiry
 *   drafts automatically. Defaults to false.
