...
import { SessionStore } from '../services/storage/sessionStore.js';
...
import firebaseLoginPlugin from './routes/firebaseLoginRoute.js';
...
// Cookie + session (Firestore-backed store, signed cookie).
//
...
await fastify.register(fastifySession, {
  ...
  // Sessions live in Firestore rather than in the library's default in-memory map: that map is lost
...
fastify.register(firebaseLoginPlugin, { prefix: '/api/login/firebase' });
